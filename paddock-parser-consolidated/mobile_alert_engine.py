...
try:
    from paddock_parser.normalizer import NormalizedRace, NormalizedRunner, normalize_course_name, parse_hhmm_any, convert_odds_to_fractional_decimal, canonical_track_key, canonical_race_key
    ...
    print(f"FATAL: Could not import paddock_parser modules. Ensure the package is installed.", file=sys.stderr)
